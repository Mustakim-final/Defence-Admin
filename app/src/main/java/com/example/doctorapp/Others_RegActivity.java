...
public class Others_RegActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Others_RegActivity.this,SignInActivity.class);
                ...
                if (task.isSuccessful()){
                    ...
                    reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(Others_RegActivity.this, "Registration successful", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(Others_RegActivity.this,SignInActivity.class);
                    ...
                    Toast.makeText(Others_RegActivity.this, "Try Another email", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
